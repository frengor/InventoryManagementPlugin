...
public class EditableGui extends EmptyGui {

    protected final ItemStack[] initialItems;

    public EditableGui(@NotNull Plugin plugin, @NotNull Player player, @NotNull String title, int size) {
        this(plugin, player, title, size, Collections.emptyList());
    }

    public EditableGui(@NotNull Plugin plugin, @NotNull Player player, @NotNull String title, int size, ItemStack... initialItems) {
    ...
    public EditableGui(@NotNull Plugin plugin, @NotNull Player player, @NotNull String title, int size, @NotNull List<@Nullable ItemStack> initialItems) {
        super(plugin, player, title, size);
